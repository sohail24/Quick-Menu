    ...
    private void seedDemoRestaurant() {
        ...
        if (dishRepo.countByRestaurantId(r.getId()) == 0) {
            ...
            dishes.add(Dish.builder()
                    ...
                    .imageUrl("https://res.cloudinary.com/dd0vsg58y/image/upload/v1767455131/vkiphqhjqeav3ozv811s.png")
                    .isAvailable(true)
                    .prepTimeMins(10)
            ...
            dishes.add(Dish.builder()
                    ...
                    .imageUrl("https://res.cloudinary.com/dd0vsg58y/image/upload/v1767455391/uzbjzj1ombz1sv20qf1d.png")
                    .isAvailable(true)
                    .prepTimeMins(8)
            ...
            dishes.add(Dish.builder()
                    ...
                    .imageUrl("https://res.cloudinary.com/dd0vsg58y/image/upload/v1767454817/tsq2scj91pwvmff6u8rq.png")
                    .isAvailable(true)
                    .prepTimeMins(20)
            ...
            dishes.add(Dish.builder()
                    ...
                    .imageUrl("https://res.cloudinary.com/dd0vsg58y/image/upload/v1767455072/omu5nhhsmmkfoepn8ifl.png")
                    .isAvailable(true)
                    .prepTimeMins(5)
